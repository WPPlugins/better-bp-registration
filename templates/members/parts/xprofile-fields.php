...
<div class="screen xprofile-fields display-none screen-<?php echo $screen_count_index; ?> <?php if (($tab_count_index - 1) == $screen_count_index) { echo 'finish'; } ?>" data-screen="<?php echo $screen_count_index; ?>">
