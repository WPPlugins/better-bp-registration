<?php
/*
 * Plugin Name:         BP Better Registration
 * Author:              abwebstudio1, sooskriszta, topmba
 * Description:         This plugin replace standard bp registration process. With this plugin registration process split by steps. It's make process mach easy to understand and more comfortable.
 * Requires at least:   WordPress 4.5.3 / BuddyPress 2.6.1.1
 * Tested up to:        WordPress 4.5.3 / BuddyPress 2.6.1.1
